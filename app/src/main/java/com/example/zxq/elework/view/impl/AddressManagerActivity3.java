...
public class AddressManagerActivity3 extends AbstractStateActivity implements AddressManagerView, View.OnClickListener{
    ...
    public static void actionStart(Context context){
        Intent intent = new Intent(context, AddressManagerActivity3.class);
    ...
    private void initWidget() {
        ...
        addAddressText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AddressAddActivity.addActionStart(AddressManagerActivity3.this);
            }
        });
    ...
    class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            holder.addressView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AddressAddActivity.updateActionStart(AddressManagerActivity3.this, addressDO, itemPos);
                }
            });
            return holder;
        }
        ...
        private AlertDialog.Builder getAlertDialog(){
            if (dialog == null){
                dialog = new AlertDialog.Builder(AddressManagerActivity3.this);
